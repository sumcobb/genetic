...
/*
/* Obviously a good algorithm designer, with external knowledge of the system,
/* the robot's position, and environment and constraints  could design an
/* algorithm that can avoid bouncing into walls etc, but the point is that Robby
/* has no other knowledge of the system than his current context, i.e. he does
/* not know how large the system is, what shape it is, or any other information
/* except his current context.
/*
        ...
        for (int agent = 0; agent < NR_AGENTS; agent++)
        {
            ...
            for (int session = 0; session < SESSIONS; session++)
            {
                ...
                for (int steps = 0; steps < nr_steps; steps++)
                {
                    ...
                    // the index for that context, getting the action for that index
